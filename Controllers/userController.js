...
const serverKey =  "AIzaSyC9Jsn9pAd5W4dnBJL9T8R8gtpCfdbRUeo"; // Update with your FCM server key
...
exports.signup = async (req, res) => {
  try {
    ...
    sendNotification('New User Registered', 'A new user has registered.');
...
const sendNotification = (title, body) => {
  const message = {
    to: 'DEVICE_TOKEN', // Replace with the token of the device to receive the notification
    notification: {
      title,
      body,
    },
